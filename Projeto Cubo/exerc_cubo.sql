...
--------CONVêNIO. DICA: FAZER UM CONTADOR PARA O NúMERO DE ATENDIMENTOS.
                  ...
                  SELECT Max(ATENDIME.CD_ATENDIMENTO)AS QTD
                  FROM(
...
--------CONVENIO, NOME DO PACIENTE E VALOR UNITáRIO E VALOR TOTAL. DICA: UTILIZAR A COLUNA
--------SN_FECHADA DA REG_AMB E REG_FAT.

            SELECT ITREG_AMB.CD_REG_AMB
                  ,ITREG_FAT.CD_REG_FAT
                  ,CONVENIO.NM_CONVENIO
                  ,PACIENTE.NM_PACIENTE
                  ,Sum( ITREG_FAT.vl_unitario)AS VALOR_TOTAL_INT
                  ,Sum( ITREG_AMB.vl_unitario)AS VALOR_TOTAL_INT

            FROM  REG_AMB,ITREG_AMB, ITREG_FAT, REG_FAT,CONVENIO,PACIENTE
            WHERE ITREG_AMB.SN_FECHADA = REG_AMB.SN_FECHADA
